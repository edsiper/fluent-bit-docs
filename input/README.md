...
| [cpu](metrics/cpu.md) | CPU Usage | measure total CPU usage of the system. |
| [disk](metrics/disk.md) | Disk Usage | measure Disk I/Os. |
...
| [mem](metrics/mem.md) | Memory Usage | measure the total amount of memory used on the system. |
...
| [thermal](metrics/thermal.md) | Thermal | measure system temperature\(s\). |
